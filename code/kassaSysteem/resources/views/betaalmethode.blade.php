...
<div class="bg-white p-4 rounded-lg shadow-lg w-full max-w-3xl">
    ...
    <div class="flex gap-2 mt-4">
        <button type="submit" class="w-2/4 h-auto bg-red-300 py-8 rounded-md hover:bg-red-200 transition-colors flex justify-center">
            <img src="http://kassasysteem.test/assets/images/red_arrow.png" alt="">
        </button>
    </div>
</div>
